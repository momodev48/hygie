...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Premier",sLast:"Dernier",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"No data available in table",sInfo:"Pages de _START_ à _END_ Résultat total _TOTAL_ lignes",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtré de _MAX_ résultat total)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Affichage de _MENU_ lignes",sLoadingRecords:"Chargement...",sProcessing:"Traitement...",sSearch:"Chercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,
